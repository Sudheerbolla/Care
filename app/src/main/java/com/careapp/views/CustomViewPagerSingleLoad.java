...
public class CustomViewPagerSingleLoad extends ViewGroup {
    ...
    public CustomViewPagerSingleLoad(Context context) {
        super(context);
        initViewPager();
    }

    public CustomViewPagerSingleLoad(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
